...
export default function ContactComponent() {
  ...
  return (
    <div className="isolate bg-white px-6 pt-24 pb-12 sm:pt-32 sm:pb-12 lg:px-8">
      ...
      >
        <div
          className="relative left-1/2 -z-10 aspect-[1/1] w-[70rem] max-w-none -translate-x-1/4 rotate-[45deg] bg-gradient-to-tr from-[#ff80b5] via-[#9089fc] to-[#9089fc] opacity-20 sm:left-[calc(50%-40rem)] sm:w-[100rem]"
          style={{
            clipPath:
